    ...
    <a-card :bordered="false" class="general-card bpm-dashboard-card">
      <template #title>
        <div class="card-header">
          <icon-copy class="header-icon" />
          <span class="header-text">收到的抄送</span>
        </div>
      </template>
        ...
        <div class="bpm-tree-content">
          ...
          >
            <template #ccType="{ record }">
              <a-tag
                :color="typeMap[record.ccType]?.color"
                bordered
                size="small"
              >
            ...
            <template #isRead="{ record }">
              <a-tag
                :color="readMap[record.instCp.isRead]?.color"
                bordered
                size="small"
              >
